      ...
      <AdminLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[1,2,3,4].map(i => (
              <div key={i} className="card">
                <div className="animate-pulse bg-gray-200 rounded w-24 h-3 mb-2" />
          ...
          <div className="card flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
            ...
            <div className="flex gap-2">{[1,2,3,4].map(i => <div key={i} className="animate-pulse bg-gray-200 rounded-lg w-20 h-8" />)}</div>
          </div>
          <div className="card p-0">
            <table className="table">
              <thead><tr>{['Date','User','Reference','Loan','Amount','Gateway','Status','Actions'].map(h => <th key={h}><div className="animate-pulse bg-gray-200 rounded w-14 h-4" /></th>)}</tr></thead>
              <tbody>
                {[1,2,3,4,5].map(i => (
                  <tr key={i}>
                    <td><div className="animate-pulse bg-gray-200 rounded w-20 h-4" /></td>
                    <td><div><div className="animate-pulse bg-gray-200 rounded w-24 h-4 mb-1" /><div className="animate-pulse bg-gray-200 rounded w-32 h-3" /></div></td>
                    ...
                    <td><div className="animate-pulse bg-gray-200 rounded w-6 h-6" /></td>
                  </tr>
                ))}
              </tbody>
            </table>
